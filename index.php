    ...
    <div class="box box-primary" style="margin: 10px;">
      ...
      <div class="row" style="margin: 10px;">
        <div class="col-md-12">
          ...
          <div class="row">
              <div class="col-md-3">
                <h3 class="text-muted">Detox Thailand</h3>
              </div>
              <div class="col-md-9">
                <nav>
