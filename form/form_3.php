                  ...
                  <td>
                    ...
                    <?Php
                      $question = array(
                                        ...
                                        "5"=>'e) รับประทานขนม <br> <input placeholder="เช่น..." type="text" class="form-control" id="p3a5c1" value="'.$dataform['p3a5c1'].'">',
                                        ...
                                        "11"=>'k) รับประทานวิตามิน หรืออาหารเสริมต่างๆ <br> <input placeholder="เช่น..." type="text" class="form-control" id="p3a11c1" value="'.$dataform['p3a11c1'].'">',
                                        "12"=>'l) ดื่มเครื่องดื่มที่มีรสหวาน <br> <input placeholder="เช่น..." type="text" class="form-control" id="p3a12c1" value="'.$dataform['p3a12c1'].'">',
                                        "13"=>'m) ดื่มกาแฟ <br> <input placeholder="เช่น..." type="text" class="form-control" id="p3a13c1" value="'.$dataform['p3a13c1'].'">',
                                        "14"=>"n) สูบบุหรี่",
                                        "15"=>"o) ดื่มสุรา เบียร์ กระแช่ ไวน์",
                                        "16"=>'p) สารสเพติด <br> <input placeholder="เช่น..." type="text" class="form-control" id="p3a16c1" value="'.$dataform['p3a16c1'].'">',
