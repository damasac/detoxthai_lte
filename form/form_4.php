              ...
              var size_media = 5400900*40; //200MB
                ...
                <tr>
                  <td>
						...
						<?php
							$sql = "SELECT `id`, `file_name`, file_type FROM tbl_surveyfile WHERE ref_form='".$_GET['form_id']."' AND ref_field='p4a8' AND ref_user='".$_SESSION['dtt_user_form']."' ORDER BY id DESC;";
							//echo $sql;
