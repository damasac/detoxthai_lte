...
<section class="content">
  ...
  <div class="box box-default">
    <div class="box-body">
      <h2>
      <p class="text-center">ข้อมูลทั้งหมดที่เกี่ยวข้องกับศูนย์นี้ จะหายไปจาก DetoxThai อย่างถาวร</p>
      <br>
      </h2>
      <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          <a href="site_delete_hide.php?site_id=<?php echo $site_id; ?>" class="btn btn-block btn-danger btn-lg">ยืนยันการลบ</a>
