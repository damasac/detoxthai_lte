...
--
-- Table structure for table `site_follow`
--

CREATE TABLE IF NOT EXISTS `site_follow` (
  `id` int(11) NOT NULL,
...
INSERT INTO `site_manage_user` (`id`, `site_id`, `user_id`, `create_at`, `delete_at`) VALUES
(6, 2, 4, '2015-06-15 05:20:58', NULL),
(9, 2, 9, '2015-06-15 05:22:19', NULL);
...
INSERT INTO `site_menu` (`id`, `menu_order`, `site_id`, `menu_name`, `display_menu`, `content_id`, `create_at`, `delete_at`) VALUES
(254, 4, 2, 'ติดต่อเรา', 0, 412, '2015-06-14 09:55:22', NULL),
(252, 2, 2, 'เกี่ยวกับเรา', 0, 408, '2015-06-14 09:55:22', NULL),
(253, 3, 2, 'เกี่ยวกับการล้างพิษ', 0, 409, '2015-06-14 09:55:22', NULL),
(251, 1, 2, 'หน้าหลัก', 0, 407, '2015-06-14 09:55:22', NULL),
(247, 1, 1, 'หน้าหลัก', 0, 401, '2015-06-12 12:56:22', NULL);
...
INSERT INTO `site_submenu` (`id`, `menu_order`, `site_id`, `menu_name`, `status_menu`, `main_menu_id`, `content_id`, `create_at`, `delete_at`) VALUES
(161, 3, 2, 'รวมภาพกิจกรรมล้างพิษตับ', 0, 253, 411, '2015-06-14 09:55:22', NULL),
(160, 2, 2, 'การเตรียมตัวมาเข้าค่ายล้างพิษตับ', 0, 253, 410, '2015-06-14 09:55:22', NULL),
(158, 2, 1, 'การเตรียมตัวมาเข้าค่ายล้างพิษตับ', 0, 249, 404, '2015-06-12 12:56:22', NULL),
(159, 3, 1, 'รวมภาพกิจกรรมล้างพิษตับ', 0, 249, 405, '2015-06-12 12:56:22', NULL);
...
--
-- Indexes for table `site_follow`
--
ALTER TABLE `site_follow`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `site_follow`
--
ALTER TABLE `site_follow`
