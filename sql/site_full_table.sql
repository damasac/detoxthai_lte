...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2015 at 05:39 AM
...
INSERT INTO `site_detail` (`id`, `site_name`, `site_url`, `site_province`, `site_amphur`, `site_district`, `site_house_no`, `site_village_no`, `site_muban`, `site_postal_code`, `site_telephone`, `site_mobile`, `create_user`, `create_date`) VALUES
(50, 'ศูนย์หลัก', 'main', 0, 0, 0, '', 0, '', 0, '', '', 1, '2015-06-10 03:38:08'),
(49, 'ไอมิวสุขภาพดี', 'imu', 21, 281, 2459, '1', 3, 'ลำหอก', 32110, '-', '0876471994', 1, '2015-06-09 04:44:39');

-- --------------------------------------------------------

--
-- Table structure for table `site_join`
--

CREATE TABLE IF NOT EXISTS `site_join` (
  `id` int(11) NOT NULL,
  `schedule_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `payment_status` int(11) NOT NULL DEFAULT '0',
  `payment_upload_status` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `site_join` (`id`, `schedule_id`, `user_id`, `payment_status`, `payment_upload_status`, `image_path`) VALUES
(13, 16, 1, 1, 1, 'design-face-art-wallpaper-1680x1050.jpg');

-- --------------------------------------------------------

--
-- Table structure for table `site_manage_user`
--

CREATE TABLE IF NOT EXISTS `site_manage_user` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `site_manage_user`
--

INSERT INTO `site_manage_user` (`id`, `site_id`, `user_id`) VALUES
(2, 49, 1),
(3, 49, 1);
...
INSERT INTO `site_menu` (`id`, `menu_order`, `site_id`, `menu_name`, `display_menu`, `content_id`) VALUES
(133, 3, 49, 'คอร์สล้างพิษตับ', 0, 214),
(135, 1, 50, 'หน้าหลัก', 0, 219),
(134, 4, 49, 'ติดต่อเรา', 0, 218),
(132, 2, 49, 'เกี่ยวกับเรา', 0, 213),
(131, 1, 49, 'หน้าหลัก', 0, 212),
(136, 2, 50, 'เกี่ยวกับเรา', 0, 220),
(137, 3, 50, 'คอร์สล้างพิษตับ', 0, 221),
(138, 4, 50, 'ติดต่อเรา', 0, 225);
...
CREATE TABLE IF NOT EXISTS `site_schedule` (
  ...
  `schedule_payment` text COLLATE utf8_unicode_ci NOT NULL,
  `schedule_after_payment` text COLLATE utf8_unicode_ci NOT NULL,
  `site_id` int(11) NOT NULL
...
INSERT INTO `site_schedule` (`id`, `schedule_name`, `schedule_date`, `schedule_end_date`, `user_qty`, `price_per_person`, `schedule_desc`, `schedule_payment`, `schedule_after_payment`, `site_id`) VALUES
(16, 'sdfsdf', '2015-09-06', '2015-09-06', 1499, 1500, 'sdfdf', 'sdfsdf', 'sdf', 49),
(17, 'sdf', '2015-09-06', '2015-09-06', 5000, 500000, '[color=#ff3333][size=7]sdfdsf[/size][/color]', '[color=#669933][size=7]sdfsdf[/size][/color]', '[color=#996699][size=7]sdfdf[/size][/color]', 49);
...
INSERT INTO `site_submenu` (`id`, `menu_order`, `site_id`, `menu_name`, `status_menu`, `main_menu_id`, `content_id`) VALUES
(88, 1, 50, 'ปฎิทินกิจกรรมล้างพิษตับ', 0, 137, 222),
(86, 2, 49, 'การเตรียมตัวมาเข้าค่ายล้างพิษตับ', 0, 133, 216),
(87, 3, 49, 'รวมภาพกิจกรรมล้างพิษตับ', 0, 133, 217),
(85, 1, 49, 'ปฎิทินกิจกรรมล้างพิษตับ', 0, 133, 215),
(89, 2, 50, 'การเตรียมตัวมาเข้าค่ายล้างพิษตับ', 0, 137, 223),
(90, 3, 50, 'รวมภาพกิจกรรมล้างพิษตับ', 0, 137, 224);
...
--
-- Indexes for table `site_join`
--
ALTER TABLE `site_join`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `site_manage_user`
--
ALTER TABLE `site_manage_user`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `site_submenu`
--
ALTER TABLE `site_submenu`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `site_submenu`
--
ALTER TABLE `site_submenu`
